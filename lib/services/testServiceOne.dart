...
import 'package:pheonix/utils/constants.dart';
import 'package:web3dart/web3dart.dart';

Future<DeployedContract> loadContract() async {
  String abi = await rootBundle.loadString('contracts/build/contracts/Node.json');
  var jsonAbi = jsonDecode(abi);
  var abiCode = jsonEncode(jsonAbi['abi']);
  String contractAddress = contractAddress1;
  final contract = DeployedContract(ContractAbi.fromJson(abiCode, 'Node'), EthereumAddress.fromHex(contractAddress));
  var contract_address=EthereumAddress.fromHex(jsonAbi["networks"]["5777"]["address"]);
